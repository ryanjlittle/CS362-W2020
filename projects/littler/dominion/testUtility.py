...
def GetNumCurseAndVictoryCards(num_players):
...
def GetSupply(num_players):
    nV, nC = GetNumCurseAndVictoryCards(num_players)
    box = GetBox(nV)
    supply = ChooseRandomCards(box)
